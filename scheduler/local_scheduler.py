...
if __name__ == '__main__':
    ...
    #init the cluster
    cluster = SLURMCluster(cores=2,processes=2,memory="190GB",
        account="mgm",queue="GPU",walltime="09:00:00",
        job_script_prologue=['source /u/area/ntosato/scratch/pippo/ForwardForward-machiavelli/dask_gpu/bin/activate', ], )
    cluster.scale(8)
